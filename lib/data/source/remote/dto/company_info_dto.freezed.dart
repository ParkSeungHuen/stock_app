...
// nullable로 만드는 이유 : null값이 들어올 경우 대비, 이후 리팩토링
  @JsonKey(name: 'Symbol')
  String? get symbol => throw _privateConstructorUsedError; // JsonKey로 변환, 매핑
...
abstract class _CompanyInfoDto implements CompanyInfoDto {
  ...
  @override // nullable로 만드는 이유 : null값이 들어올 경우 대비, 이후 리팩토링
  @JsonKey(name: 'Symbol')
  String? get symbol;
  @override // JsonKey로 변환, 매핑
  @JsonKey(name: 'Description')
