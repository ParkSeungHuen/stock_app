...
import 'package:stock_app/presentation/company_info/component/stock_chart.dart';
        ...
        children: [
          Text(
            ...
            style: const TextStyle(
              ...
              fontSize: 18,
              overflow: TextOverflow.ellipsis, // 넘어가는게 ...
            ),
          ),
          Text(
          ...
          if (state.stockInfos.isNotEmpty) Padding(
            ...
            child: StockChart(infos: state.stockInfos, graphColor: Theme.of(context).colorScheme.primary, textColor: Theme.of(context).colorScheme.onSurface,),
          )
        ],
      ),
    );
