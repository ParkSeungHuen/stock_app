                          ...
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(builder: (context) {
                                final repository = GetIt.instance<StockRepository>(); // 객체 가져오기
                                final symbol = state.companies[index].symbol;

                                return ChangeNotifierProvider(create: (_) => CompanyInfoViewModel(repository, symbol), child: const CompanyInfoScreen(),); // 화면을 불러오면서 바로 repository와 symbol 전달하면서 화면 전환
                              })
                            );
                          },
                        ),
